...
SteeringDisplay::SteeringDisplay(SPI_TFT_ILI9341 *tft, SharedProperty<data_t> &menu) : _tft(tft)
{
	menu.addValueChangedListener(new Delegate<SteeringDisplay, data_t>(this, &SteeringDisplay::_onMenuChanged));
...
void SteeringDisplay::_onMenuChanged(const data_t value)
{
	_menu = value;
}
